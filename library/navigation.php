 ...
 * Menu Footer
 */
if ( ! function_exists( 'foundationPress_menu_footer' ) ) {
	function foundationPress_menu_footer() {
	    wp_nav_menu(array( 
	        'container' => false,                           // remove nav container
	        'container_class' => '',                        // class of container
	        'menu' => '',                                   // menu name
	        'menu_class' => 'inline-list grey',           // adding custom nav class
	        'theme_location' => 'menu_footer',                // where it's located in the theme
	        'before' => '',                                 // before each link <a> 
	        'after' => '',                                  // after each link </a>
	        'link_before' => '',                            // before each link text
	        'link_after' => '',                             // after each link text
